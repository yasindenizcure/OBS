Okul Bilgi Sistemi yada kısaca OBS, üniversiteler için geliştirilmiş, yönetici ve akademisyenlerin öğrenci süreçlerini uçtan uca yönetebildiği, cyberpunk temalı şık bir ASP.NET Core MVC web uygulamasıdır.
